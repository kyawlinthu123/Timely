  ...
  const features = [
    {
      ...
      description:
        "No more all-nighters or forgotten assignments. Timely keeps your deadlines visible, organized, and stress-free.",
    },
    {
      icon: <Timer className="w-6 h-6" />,
      title: "Focus Without Burning Out",
      description:
        "Use Focus Mode and the built-in Pomodoro timer to stay sharp. Work in bursts, take breaks, and see your progress build up.",
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Understand Your Productivity",
      description:
        "Get real insights into how you study. Discover when you’re most focused and fine-tune your study rhythm.",
    },
    {
      icon: <StickyNote className="w-6 h-6" />,
      title: "Notes That Stay in Context",
      description:
        "Attach notes directly to classes or assignments. Review everything in one clean, clutter-free view.",
    },
    {
      icon: <Bell className="w-6 h-6" />,
      title: "Smart Reminders",
      description:
        "Never get caught off guard. Receive reminders just when you need them — by email, SMS, or right inside the app.",
    },
    {
      icon: <BookOpen className="w-6 h-6" />,
      title: "Simplify Your Semester",
      description:
        "Manage multiple classes effortlessly. Each subject has its own space for assignments, notes, and tracking.",
    },
  ];
      ...
      <section className="px-4 py-20 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mb-8 text-xl text-gray-600">
            No more chaos. No missed deadlines. Just calm, focus, and results.
            Timely turns your student life into a smooth, stress-free system
            that actually works.
          </p>
      ...
      >
        <div className="mb-16 text-center">
          ...
          <p className="text-xl text-gray-600">
            More than just a calendar. It's your complete academic productivity
            system.
          </p>
        </div>
          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Create classes for each of your courses. Organize everything in
                one place.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Add deadlines, set priorities, and get reminders. Never miss
                another due date.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Use focus mode to study, track your time, and watch your
                productivity soar.
              </p>
            </div>
          </div>
      ...
      <section className="px-4 py-20 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="p-12 text-center border-2 border-green-200 bg-green-50 rounded-2xl">
          ...
          <p className="mb-8 text-xl text-gray-700">
            Join thousands of students staying organized, focused, and
            stress-free with Timely.
          </p>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="text-sm text-center text-gray-600">
              © 2025 Timely. Made for students who want to stay on top of their
              game.
              <div className="mt-1">
                Made by{" "}
                <a href="https://github.com/kyawlinthu123" target="_blank">
                  {" "}
                  <span className="font-semibold">Kyaw Lin Thu</span>{" "}
                </a>
              </div>
            </div>
          </div>
